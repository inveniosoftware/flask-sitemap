...
htmlhelp_basename = 'Flask-Sitemapdoc'
...
latex_documents = [
  ('index', 'Flask-Sitemap.tex', u'Flask-Sitemap Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    ('index', 'flask-sitemap', u'Flask-Sitemap Documentation',
     [u'CERN'], 1)
]
...
texinfo_documents = [
  ('index', 'Flask-Sitemap', u'Flask-Sitemap Documentation',
   u'CERN', 'Flask-Sitemap', 'One line description of project.',
   'Miscellaneous'),
]
